...
## Auto-scaling with Machine API Operator
To enable secondary interface attachment via the Machine API Operator, you must:
1. Modify the `AWSMachineProviderConfig` to specify additional network interfaces.
2. Update the machine-api-controller for AWS provider support.

### References for Machine API Operator
